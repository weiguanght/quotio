...
struct SettingsScreen: View {
    ...
    var body: some View {
        WithPerceptionTracking {
            @Perception.Bindable var lang = LanguageManager.shared
...
struct UnifiedProxySettingsSection: View {
    ...
    private var isAPIAvailable: Bool {
        if modeManager.isLocalProxyMode {
            ...
            // connectionStatus is observable, apiClient is not (@PerceptionIgnored)
...
struct NotificationSettingsSection: View {
    ...
    var body: some View {
        WithPerceptionTracking {
            @Perception.Bindable var manager = notificationManager
